...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0001
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0002
% Source page 19 - left
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0003
...
If $x^2+y^2=1$, then $x=\sin\theta$ and $y=\cos\theta$ for a suitable $\theta$.
\end{lemma}
This elementary idea solves a deceptively difficult IMOTC 2014 problem.
Let $x,y$ be rational numbers and $x^5+y^5=2x^2y^2$. Prove that $1-xy$ is a rational square.
If $xy=0$, the equation forces $x=y=0$, and the result is immediate. Hence assume $xy\ne0$.
Then
\[
...
\]
so $1-xy$ is the square of a rational number.

% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0004
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0005
...
\setcounter{enumi}{2}\item If $a,b,c>0$ and $abc=1$, then
$x=a+1/a$, $y=b+1/b$, $z=c+1/c$ satisfy $x^2+y^2+z^2-xyz=4$.
Its validity follows by expanding $xyz=(a+1/a)(b+1/b)(c+1/c)$.
This parametrizes the component with $x,y,z\geq2$; it is not a parametrization of every real solution.
\setcounter{enumi}{3}\item If $A,B,C$ are the angles of a triangle, then
$x=2\cos A$, $y=2\cos B$, $z=2\cos C$ satisfy $x^2+y^2+z^2+xyz=4$.
Equivalently, after rescaling, $x=\cos A$, $y=\cos B$, $z=\cos C$
satisfy $x^2+y^2+z^2+2xyz=1$.
...
Put $s=x+y+z$. The second equation gives $xy+yz+zx=s+6$, while the
first gives $xyz=s^2-2s-16$. Thus $x,y,z$ are the three roots of
\[
t^3-st^2+(s+6)t-(s^2-2s-16).
\]
Since $xy+yz+zx\leq s^2/3$ and $x,y,z>0$, we have $s\geq6$.
The discriminant of this cubic is
\[
(x-y)^2(y-z)^2(z-x)^2=-4(s-6)^2(s+3)^2(s+6).
\]
The left-hand side is nonnegative, so $s=6$. Hence
$xy+yz+zx=12=s^2/3$, which forces $x=y=z=2$.

% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0006
On the component covered by the substitution, put
$x=a+1/a$, $y=b+1/b$, $z=c+1/c$, with $abc=1$. Then
\[
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0007
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0008
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0009
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0010
\paragraph{It was obvious!}
Let $a,b,c$ be sides of a triangle similar to $ABC$. The proposed problem is
\[
2c^3+ab+bc+ca>a^3+b^3+c^3+3abc.
\]
One may try to prove
$(a+b+c)(ab+bc+ca)+c^3>a^3+b^3+3abc$ by using
\[
a^3+b^3-c^3+3abc-\left(\sum ab\right)\left(\sum a\right)
=\left(\sum a\right)\left(\sum a^2-2\sum ab\right)<0.
\]
Now, because it is homogeneous, the proposed argument assumes $a+b+c=1$.
But the original inequality is not homogeneous: for $a=b=c=t$ it becomes
$3t^2>4t^3$, which fails when $t\geq3/4$. Thus the statement needs a scale
normalization before this argument can apply.
The actual problem was to find the range of the area, given that $ABC$ is equilateral. Try it!

% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0011
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0012
% Source page 58 - left
...
\setcounter{enumi}{8}\item Under the change of variables
$x=2a$, $y=2b$, and $z=2c$, the identity
$a^2+b^2+c^2+2abc=1$ is equivalent to $x^2+y^2+z^2+xyz=4$.
\end{enumerate}
\end{lemma}
% Source page 58 - right
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0013
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0014
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0015
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0016
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0017
\paragraph{Problem 2.}
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0018
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0019
\paragraph{Ingenious trigonometric substitution.}
Let $x,y,z>0$ satisfy $xy+yz+zx=3xyz$. Prove $(2y+2z+x)^2>12xyz$.
% Source page 4 - right
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0020
From the condition,
...
% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0021
That inequality using trigonometric substitution was all pure dumbass; sorry I did not realize it.
Pranjal pointed out that one should substitute
$12xyz=4xy+4yz+4zx$ and prove it directly. It was that obvious!
Let me rephrase it.
Let $x,y,z$ be positive integers satisfying $xy+yz+zx=3xyz$.
Prove $27xyz>8(x+y+z)$ in two different ways.

% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0022
\paragraph{APMO (1996).}
For the side lengths $a,b,c$ of a triangle, prove
$\sqrt{a+b-c}+\sqrt{b+c-a}+\sqrt{c+a-b}\leq\sqrt a+\sqrt b+\sqrt c$.

% BLOG-PASSAGE: lemma-book-triangle-inequalities-trigonometric-substitutions:p0023
% Source page 17 - left
