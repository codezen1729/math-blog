...
To extract geometric information from a holomorphic function, we need a precise understanding of curve homotopies. Holomorphic functions can be integrated along continuous curves, and the integral is invariant under homotopies that remain in the domain of holomorphy.
% BLOG-CONTENT-END
\end{document}
