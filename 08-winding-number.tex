...
% BLOG-CONTENT-BEGIN
Before proceeding with some other standard techniques, let us have a quick exposition on singularities.
...
\[
  ...
  \{z\mid W_\gamma(z)=0\}
\]
are connected. It is easy to see that \(\{z\mid W_\gamma(z)=0\}\) is the unbounded component, or the exterior. Let us resume our exposition on singularities later.
