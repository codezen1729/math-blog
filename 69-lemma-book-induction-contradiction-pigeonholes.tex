...
We assume that extending $C_2X$ does not form a chord.
...
\end{lemma}
Let me present a beautiful proof of this fact! Let $|a_i-i|=|x_i|$.
...
which is odd. A contradiction! Q.E.D. (There is another way to solve it; find it!)
