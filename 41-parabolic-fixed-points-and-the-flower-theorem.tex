...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0001
...
% Source page 2
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0002
...
\end{theorem}
% Source page 3
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0003
\begin{proof}
We employ the same technique mentioned earlier. First let us state explicitly what we expect. Choose a repelling vector $v_0$ and set $v_j=e^{\pi ij/n}v_0$: $v_j$ is attracting if $2\nmid j$, and repelling if $2\mid j$.
\begin{figure}[H]\centering
...
\]
must contain the orbit eventually; it must also approach $0$ asymptotically in an attracting direction $v_j$. We hope to obtain the necessary bounds by conjugating the iterates to another hyperbolic surface, leaving the rest to Pick's theorem. Define the biholomorphism
\[
...
\end{definition}
% Source page 7
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0004
...
% Source page 8
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0005
...
\]
Then $P_j=\psi_j(W_R)\subset\Delta_j$ is an attracting petal for odd $j$ and large $R$. Similarly, $P_j=\psi_j(-W_R)$ is a repelling petal for even $j$.
\begin{figure}[H]\centering
...
\end{proof}
% Source page 10
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0006
...
\end{observation}
% Source page 11
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0007
By Cauchy's estimate, $|F'(w)-1|<C/S^{1+1/n}$ when $|w|\ge2S\ge2R$. Given $w',w''\in\mathbb H_{2S}$,
\[
\frac1{w''-w'}\int_{\gamma_{w'\to w''}}(F'(w)-1)\,dw
=\frac{F(w'')-F(w')}{w''-w'}-1,
\]
so the modulus of the right-hand side is at most $C/S^{1+1/n}$. Since $\Re F^{\circ k}(w)>k/2$, eventually
\[
...
\]
% Source page 12
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0008
Multiplying \eqref{cd3:ratio-bound} and \eqref{cd3:product-bound}, with $k-1$ in the latter, gives
\[
|\beta_k(w)-\beta_{k-1}(w)|\le\frac{PC'|w-\widehat w|}{k^{1+1/n}}.
\]
...
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0009
To see univalence, choose $k_0$ such that $1-C'/k_0^{1+1/n}>0$. Then $|\beta_k(w)/\beta_{k-1}(w)|>0$, so $F_j^{\circ k}$ is eventually univalent: the positive lower bound is independent of $w,\widehat w$ for every $k\ge k_0$. Hence $\beta$ is univalent.
\begin{observation}[2]
$\beta(F_j(w))=\beta(w)+1$.
\end{observation}
Fix $k$. We have $\beta_k(w)\sim F_j^{\circ k}(w)$ and $|F_j(w)-w-1|=O(1/\sqrt[n]{|w|})$.
% Source page 13
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0010
...
% Source page 14
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0011
...
% BLOG-PASSAGE: parabolic-fixed-points-and-the-flower-theorem:p0012
