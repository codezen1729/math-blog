...
If triangles $ABC$ and $A'B'C$ are oppositely similar, with the displayed
order giving the vertex correspondence, then $A,B,B',A'$ are concyclic.
\end{lemma}
A direct angle chase proves the result.
...
\end{lemma}
Many olympiad problems ask the solver to prove that a segment is tangent to a circle.
Instead of drawing the circle, a simple angle chase establishing the converse of the alternate-segment theorem completes the proof.
Here is an IMO problem solved by combining the two lemmas above.
