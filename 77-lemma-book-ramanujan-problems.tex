...
% Author check: the first RHS b² coefficient is read as 8 from the native-resolution crop (the handwritten digit can resemble 5); the resulting expression is not a polynomial identity. Please confirm this digit and the other coefficients.
