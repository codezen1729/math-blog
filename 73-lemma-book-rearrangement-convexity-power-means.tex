...
since $abc=1$. Q.E.D.!
There are two more possible Q.E.D.s for this problem; the next is an ingenious application of AM--GM.
...
Since $(2,1,0)\succ(5/3,2/3,2/3)$, the result follows. Q.E.D.!
...
Now let us proceed on our eternal journey. Let me show you the magic of convexity--concavity arguments: problems get resolved in seconds!!

% Source page 49 - left
So far, so good. By the way, did you figure out how to resolve the challenge we came across two pages ago?
...
>\frac{x_3^2}{2}+\frac{x_2^3}{3}+\frac{x_1^6}{6}\geq x_1x_2x_3,\\
...
The source also annotates $ab+bc+ca=3$.
\[
