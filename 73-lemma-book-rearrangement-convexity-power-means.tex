...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0001
...
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0002
...
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0003
...
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0004
...
\[\frac13\left(\frac{x_1^5}{x_2x_3}+\frac{x_2^2}{x_1x_3}+\frac{x_3}{x_1x_2}\right)>1.\]
P.S. This problem has a two-line solution, so don't think that it is complicated!
So far, so good. By the way, did you figure out how to resolve the challenge?
Hold on: here comes that two-line solution!
% Source page 49 - left
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0005
\[
\begin{aligned}
x_3^2\geq x_2^3\geq x_1^6
&\quad\Longrightarrow\quad
\frac13(x_3^2+x_2^3+x_1^6)\left(\frac12+\frac13+\frac16\right)
>\frac{x_3^2}{2}+\frac{x_2^3}{3}+\frac{x_1^6}{6}
\geq x_1x_2x_3,\\
\frac{x_3^2+x_2^3+x_1^6}{x_1x_2x_3}>3
&\quad\Longrightarrow\quad
\frac{x_1^5}{x_2x_3}+\frac{x_2^2}{x_1x_3}+\frac{x_3}{x_1x_2}>3.
\end{aligned}
\]
W$^5$. Q.E.D.! You see, we are done in just two steps!
The first comparison has the wrong direction. In fact, $(a,b,c)=(4,3,1)$
gives a left-hand sum of approximately $2.753<3$, so the challenge as written needs correction.

% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0006
Now let us proceed on our eternal journey. Let me show you the magic of
convexity--concavity arguments: problems get resolved in seconds!!

% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0007
...
% BLOG-PASSAGE: lemma-book-rearrangement-convexity-power-means:p0008
