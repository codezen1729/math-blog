...
\[
\Q:=\{(x,y)\in\Z\times\Z\}/{\sim},\qquad
(x_1,y_1)\sim(x_2,y_2)\ \Longleftrightarrow\ x_1y_2-y_1x_2=0.
\]
% Author check: the source does not exclude zero denominators in this recollection.
...
% Author check: the plus sign is present in the handwritten source.
\end{itemize}
