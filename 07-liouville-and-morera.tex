...
\textbf{Note.}
This result follows from Morera's Theorem and
...
The next two applications illustrate Tool 17 before another application of Morera
in action.
...
\textbf{Exercise.}
Give an analytic version of this geometric argument.
