...
% BLOG-PASSAGE: liouville-and-morera:p0006
\subsection*{Tool 15 — Morera's Theorem}
If $f$ is continuous on a domain $\Omega$ and $\int_P f(z)\,dz=0$ for every closed polygonal path $P\subset\Omega$, then $f$ is holomorphic.

% BLOG-PASSAGE: liouville-and-morera:p0007

\subsection*{Tool 16 — Liouville's Theorem}
An entire bounded function is constant.

% BLOG-PASSAGE: liouville-and-morera:p0008

\subsubsection*{Application — Liouville and Morera}
The next examples apply Liouville's theorem and Morera's theorem.

% BLOG-PASSAGE: liouville-and-morera:p0009
\subsection*{Fundamental Theorem of Algebra}

% BLOG-PASSAGE: liouville-and-morera:p0010
\textit{Proof.}
...
% BLOG-PASSAGE: liouville-and-morera:p0011
...
% BLOG-PASSAGE: liouville-and-morera:p0012
...
% BLOG-PASSAGE: liouville-and-morera:p0013
...
% BLOG-PASSAGE: liouville-and-morera:p0014

\textbf{Note.}
This result is intended to be shown as an instance of Morera's Theorem, but it turns out to be a technique in itself. So we prove it to serve our purpose.

% BLOG-PASSAGE: liouville-and-morera:p0015
\textit{Proof.}
...
% BLOG-PASSAGE: liouville-and-morera:p0016
Let us see two instances of Tool 17 before we show another instance of Morera in action.

% BLOG-PASSAGE: liouville-and-morera:p0017
...
% BLOG-PASSAGE: liouville-and-morera:p0018
\textit{Proof.}
Set
\[
  \Omega_\delta
...
% BLOG-PASSAGE: liouville-and-morera:p0019

Given any compact set $K$, there exists $r$ such that $B_r(z)$, for $z$ in that
compact set, is in $\Omega$. Thus $K$ is contained in
$\Omega_\delta$ for some $\delta$, and
$K_\delta:=\{t:\operatorname{dist}(t,K)\leq\delta\}$ is compact in $\Omega$.
Set $F=f_n-f$. We have
\[
...
\[
  ...
  \leq\frac1\delta\sup_{t\in K_\delta}|F(t)|,
\]
and hence
\[
  \sup_{z\in K}|F'(z)|
...
% BLOG-PASSAGE: liouville-and-morera:p0020
\subsubsection*{Application — Holomorphic parameter integrals}
Let $F$ be continuous on $\Omega\times[0,1]$, and
suppose that, for every $s\in[0,1]$, the function $z\mapsto F(z,s)$ belongs to $H(\Omega)$. Let
\[
  f(z)=\int_0^1F(z,s)\,ds.
\]
Then $f\in H(\Omega)$.

% BLOG-PASSAGE: liouville-and-morera:p0021
\textit{Proof.}
Define
\[
...
% BLOG-PASSAGE: liouville-and-morera:p0022
\textbf{Remark.}
Using these two results, one can construct elements in $H(\Omega)$ such as
$\sum_{n\geq0}f_n(z)$, provided the series converges uniformly on compact sets.

% BLOG-PASSAGE: liouville-and-morera:p0023
...
% BLOG-PASSAGE: liouville-and-morera:p0024

\textit{Proof.}
By the pasting lemma, we see that $f$ is continuous on $U$. Let $T$ be a
triangle in $U$.

% BLOG-PASSAGE: liouville-and-morera:p0025
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.82\textwidth]{note4-fig-01.pdf}

\end{figure}
\emph{Annotation:} ``Pardon the asymmetry!''

% BLOG-PASSAGE: liouville-and-morera:p0026
Set
\[
  f=
  \begin{cases}
...
\[
  \int_T f(z)\,dz=0.
\]
Morera gives the result. The only subtlety is to justify that
the integrals of these triangles vary continuously as $\varepsilon\to0$; this follows by writing the parametrizations explicitly.

% BLOG-PASSAGE: liouville-and-morera:p0027
...
% BLOG-PASSAGE: liouville-and-morera:p0028
Here is an interesting instance of the Schwarz Reflection Principle.

% BLOG-PASSAGE: liouville-and-morera:p0029
\subsubsection*{Application}
Suppose $f$ is continuous and nonvanishing on $\overline D$ and
$f\in H(D)$, and \(|f(z)|=1\iff |z|=1.\)
Then $f$ is a constant.

% BLOG-PASSAGE: liouville-and-morera:p0030
\textit{Proof.}
...
% BLOG-PASSAGE: liouville-and-morera:p0031
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\textwidth]{note4-fig-02.pdf}

\end{figure}

% BLOG-PASSAGE: liouville-and-morera:p0032
Deform $T_\varepsilon$ to $T_1$ within the domain; then
\[
  \int_{T_\varepsilon}f(z)\,dz
  =\int_{T_1}f(z)\,dz
  =0.
\]
We now approximate the relevant arcs by polygons.

% BLOG-PASSAGE: liouville-and-morera:p0033

\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\textwidth]{note4-fig-03.pdf}

\end{figure}

% BLOG-PASSAGE: liouville-and-morera:p0034
...
% BLOG-PASSAGE: liouville-and-morera:p0035
Approximating the arc by polygons gives
\[
  \int_\gamma f(z)\,dz=0.
\]
...
% BLOG-PASSAGE: liouville-and-morera:p0036
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.94\textwidth]{note4-fig-04.pdf}

\end{figure}

% BLOG-PASSAGE: liouville-and-morera:p0037
Hence
\[
  \int_T f(z)\,dz=0,
\]
...
% BLOG-PASSAGE: liouville-and-morera:p0041
...
% BLOG-PASSAGE: liouville-and-morera:p0042
\[
...
\]
Let $\theta_0\in[-\pi,\pi]$ maximize the last sum, and let
$S=S(\theta_0)$. Then
\begin{align*}
...
\]
For equally spaced points $\theta_i$ in $[-\pi,\pi]$,
\[
  2\pi\sup_\theta M_\theta
  \geq
  \sum_{i=1}^N M_{\theta_i}\left(\frac{N}{2\pi}\right)^{-1},
\]
and the expression on the right converges to $\int_{-\pi}^{\pi}M_\theta\,d\theta$ as the mesh tends to $0$. Consequently,
\[
  \sup_\theta M_\theta
