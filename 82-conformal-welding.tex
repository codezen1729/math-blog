...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: conformal-welding:p0001
% Source page 14
\subsection{Simultaneous uniformisation of Blaschke products}
We consider finite Blaschke products whose restrictions to $S^1$ are expanding.
Given two such Blaschke products $B_1,B_2$ of degree $d$, each $B_i$ is a rational map of degree $d$, and
\[
B_i(\D)=\D,
\qquad B_i(\Chat\setminus\overline\D)=\Chat\setminus\overline\D.
\]
The expansion on the whole circle gives $J(B_i)=S^1$. Thus $B_i\colon S^1\to S^1$ is a $d$-fold cover.

% BLOG-PASSAGE: conformal-welding:p0002
...
% BLOG-PASSAGE: conformal-welding:p0003
% Source page 15
...
% BLOG-PASSAGE: conformal-welding:p0004
...
% BLOG-PASSAGE: conformal-welding:p0005
The map $\psi$ is called a \emph{conformal welding} of $\gamma$.

% BLOG-PASSAGE: conformal-welding:p0006
