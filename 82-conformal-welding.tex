...
% BLOG-CONTENT-BEGIN
% Source page 14
\section{Simultaneous uniformisation of Blaschke products}
...
\]
By Montel's theorem, $J(B_i)=S^1$ (a quasicircle contained in $S^1$). Thus $B_i\colon S^1\to S^1$ is a $d$-fold cover.

There is a homeomorphism $\psi\colon S^1\to S^1$ such that $\psi\circ B_1|_{S^1}\circ\psi^{-1}\equiv B_2|_{S^1}$, and $\psi$ is quasisymmetric. This follows from $J$-stability, as $B_i$ is in the principal hyperbolic component of $\operatorname{Rat}_d$.
...
\[
F=\begin{cases}
\widetilde R_U^{-1}\circ B_1\circ\widetilde R_U,&\overline U,\\
\widetilde R_V^{-1}\circ B_2\circ\widetilde R_V,&\overline V.
\end{cases}
\]
...
\end{aligned}
\]
are conformal. The curve $\gamma=\phi(S^1)$ is a quasicircle. The maps $R_V$ and $R_U$ are given by $\phi\circ\widehat\psi$ and $\phi$, and $U,V$ are $\phi(\D),\phi(\Chat\setminus\overline\D)$.
