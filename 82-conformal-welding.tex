...
There is a homeomorphism $\psi\colon S^1\to S^1$ such that $\psi\circ B_1|_{S^1}\circ\psi^{-1}\equiv B_2|_{S^1}$, and $\psi$ is quasisymmetric. This follows from $J$-stability, since each $B_i$ lies in the principal hyperbolic component of $\operatorname{Rat}_d$.
...
\end{aligned}
\]
are conformal. The curve $\gamma=\phi(S^1)$ is a quasicircle. Set $U=\phi(\D)$ and $V=\phi(\Chat\setminus\overline\D)$. The corresponding conformal maps are $\phi\circ\widehat\psi$ and $\phi$.
