...
\chapter{Preliminaries}
        ...
        This chapter will present an overview of background material in complex dynamics that shall be of importance to us later. The content here has found excellent footings in \cite{milnor2011dynamics}, \cite{mcmullen2016complex}, and \cite{carleson2013complex}. Throughout this chapter, $f: S \rightarrow S$ is a holomorphic function and $S$ a Riemann surface (unless otherwise stated).
