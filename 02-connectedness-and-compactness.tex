...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: connectedness-and-compactness:p0001
...
% BLOG-PASSAGE: connectedness-and-compactness:p0002
...
% BLOG-PASSAGE: connectedness-and-compactness:p0003
Given a function $f\in L^1(\mu)$, we have
\[
\left|\int_X f\,d\mu\right|\leq\int_X|f|\,d\mu.
\]

% BLOG-PASSAGE: connectedness-and-compactness:p0004
\textit{Proof.}
For every $\theta$,
\begin{align*}
...
% BLOG-PASSAGE: connectedness-and-compactness:p0005
...
% BLOG-PASSAGE: connectedness-and-compactness:p0010
...
% BLOG-PASSAGE: connectedness-and-compactness:p0011
Consequently,
\[
...
% BLOG-PASSAGE: connectedness-and-compactness:p0014
\textbf{Exercise.}
Use the general version to deduce the preceding nonexistence result.

% BLOG-PASSAGE: connectedness-and-compactness:p0015

Suppose \(f^2,\ \overline f\in H(\Omega).\)
Then $f\in H(\Omega)$; in fact, $f$ is constant.

% BLOG-PASSAGE: connectedness-and-compactness:p0016
\textit{Proof.}
...
% BLOG-PASSAGE: connectedness-and-compactness:p0020
...
% BLOG-PASSAGE: connectedness-and-compactness:p0021
...
% BLOG-PASSAGE: connectedness-and-compactness:p0022
...
% BLOG-PASSAGE: connectedness-and-compactness:p0025
\textit{Proof.}
...
% BLOG-PASSAGE: connectedness-and-compactness:p0026
...
% BLOG-PASSAGE: connectedness-and-compactness:p0027
...
% BLOG-PASSAGE: connectedness-and-compactness:p0028
\begin{figure}[htbp]
  \centering
...
% BLOG-PASSAGE: connectedness-and-compactness:p0029
...
% BLOG-PASSAGE: connectedness-and-compactness:p0030
\paragraph{Case 2.}
...
% BLOG-PASSAGE: connectedness-and-compactness:p0031
\begin{figure}[htbp]
  \centering
...
% BLOG-PASSAGE: connectedness-and-compactness:p0032
...
% BLOG-PASSAGE: connectedness-and-compactness:p0033
\textbf{Remark.}
