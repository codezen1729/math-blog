...
\subsection*{Theorem 0.5} Given $p, q \in C$, there exists a meromorphic differential $\phi$ with simple poles only at $p$ and $q$.
...
where $\gamma_j$ are the smooth $1$-cocycles spanning $H^1(C, \mathbb{Z})$, then, the construction above resolves (ii) entirely. Therefore, we pause to analyse the newly introduced hypothesis.
