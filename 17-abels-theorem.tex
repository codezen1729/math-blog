...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: abels-theorem:p0001
\textbf{I)} \underline{\textbf{Prologue}}

% BLOG-PASSAGE: abels-theorem:p0002
...
% BLOG-PASSAGE: abels-theorem:p0003
...
\end{itemize}
Here non-degenerate means that $\phi(C)$ is not contained in any hyperplane of $\mathbb{CP}^n$.

% BLOG-PASSAGE: abels-theorem:p0004

\subsection*{Proposition 0.2} The image of any non-degenerate holomorphic mapping $\phi:C\rightarrow \mathbb{CP}^2$ of a compact Riemann surface is an algebraic curve.

% BLOG-PASSAGE: abels-theorem:p0005
...
% BLOG-PASSAGE: abels-theorem:p0006
...
% BLOG-PASSAGE: abels-theorem:p0007
...
% BLOG-PASSAGE: abels-theorem:p0008
...
% BLOG-PASSAGE: abels-theorem:p0009
\textbf{II)} \underline{\textbf{Landmark Theorems}}

% BLOG-PASSAGE: abels-theorem:p0010
Recall that:

% BLOG-PASSAGE: abels-theorem:p0011
\begin{enumerate}[(i)]
...
% BLOG-PASSAGE: abels-theorem:p0012
...
% BLOG-PASSAGE: abels-theorem:p0013
is well-defined. Indeed, if $\gamma\sim\gamma'$, then $\widetilde{\gamma} - \widetilde{\gamma'} = \partial \Omega$, and by Stokes' Theorem,
...
% BLOG-PASSAGE: abels-theorem:p0016
Fix $p_0\in C$ and set
$$f(p):= \int_{\gamma}\lambda$$

% BLOG-PASSAGE: abels-theorem:p0017
...
% BLOG-PASSAGE: abels-theorem:p0018
...
% BLOG-PASSAGE: abels-theorem:p0019
...
% BLOG-PASSAGE: abels-theorem:p0020
...
% BLOG-PASSAGE: abels-theorem:p0021
...
% BLOG-PASSAGE: abels-theorem:p0025
...
% BLOG-PASSAGE: abels-theorem:p0026
\begin{itemize}
...
% BLOG-PASSAGE: abels-theorem:p0027

\textbf{III)} \underline{\textbf{Jacobian Variety}}

% BLOG-PASSAGE: abels-theorem:p0028
\subsection*{Definition 0.1} Let $\gamma_1, \ldots, \gamma_{2g}$ be a basis for $H_1(C, \mathbb{Z})$. Then
$$a_{ij}:= \int_{\gamma_i}\omega_j$$

% BLOG-PASSAGE: abels-theorem:p0029
The matrix $(a_{ij})_{1\leq i\leq2g,\,1\leq j\leq g}$ is called the \textbf{period matrix} of $C$.

% BLOG-PASSAGE: abels-theorem:p0030
\subsection*{Proposition 0.4}
    Rows of the period matrix are $\mathbb{R}$-linearly independent.

% BLOG-PASSAGE: abels-theorem:p0031
...
% BLOG-PASSAGE: abels-theorem:p0032
Consider the matrix
$$m_{ij} := \begin{cases}
a_{ij}, & 1\leq i \leq g\\
...
% BLOG-PASSAGE: abels-theorem:p0033
...
% BLOG-PASSAGE: abels-theorem:p0037
...
% BLOG-PASSAGE: abels-theorem:p0038
...
% BLOG-PASSAGE: abels-theorem:p0039
\textbf{IV)} \underline{\textbf{Proof of Abel's Theorem}}

% BLOG-PASSAGE: abels-theorem:p0040
...
% BLOG-PASSAGE: abels-theorem:p0041
...
% BLOG-PASSAGE: abels-theorem:p0042
...
% BLOG-PASSAGE: abels-theorem:p0043
...
% BLOG-PASSAGE: abels-theorem:p0044
is a biholomorphism. Viewing $\mathbb{CP}^1$ as $\mathbb{C} \cup \{\infty\}$, let $f$ be the local coordinate for $\mathbb{D}_{p_j(t_0)}$, and suppose that with respect to those coordinates on $\mathbb{D}_{p_j(t_0)}$,
$$\omega_i \equiv h_{ij}(z)dz$$

% BLOG-PASSAGE: abels-theorem:p0045
...
% BLOG-PASSAGE: abels-theorem:p0046
...
% BLOG-PASSAGE: abels-theorem:p0051
Therefore,
$$u((f)) = u(D_0) - u(D_{\infty}) = 0$$

% BLOG-PASSAGE: abels-theorem:p0052
This proves (i).
\qed

% BLOG-PASSAGE: abels-theorem:p0053
...
% BLOG-PASSAGE: abels-theorem:p0054
\subsection*{Theorem 0.5} Given distinct points $p, q \in C$, there exists a meromorphic differential $\phi$ with simple poles precisely at $p$ and $q$, with opposite nonzero residues.

% BLOG-PASSAGE: abels-theorem:p0055

\textit{Proof.}
    By applying the Riemann--Roch Theorem to the divisor $D = -(p+q)$, we have
    $$l(D) - i(D) = \text{deg}(D) + 1 - g = -(g+1)$$

% BLOG-PASSAGE: abels-theorem:p0056
...
% BLOG-PASSAGE: abels-theorem:p0057
...
% BLOG-PASSAGE: abels-theorem:p0058
...
% BLOG-PASSAGE: abels-theorem:p0059
...
% BLOG-PASSAGE: abels-theorem:p0067
if and only if
$$\bigg(\int_{\gamma}\phi - \int_{\gamma'}\phi\bigg) \in \mathbb{Z}$$

% BLOG-PASSAGE: abels-theorem:p0068
...
% BLOG-PASSAGE: abels-theorem:p0069
...
% BLOG-PASSAGE: abels-theorem:p0070
\textbf{V)} \underline{\textbf{Riemann's Bilinear Relations}}

% BLOG-PASSAGE: abels-theorem:p0071
...
% BLOG-PASSAGE: abels-theorem:p0072
where $\gamma_i$ is a distinguished homology basis for $C$ described in Figure 1.
\begin{figure}[htp]
            \centering
        \includegraphics[width=0.96\linewidth]{Polygon.png}
        \end{figure}

% BLOG-PASSAGE: abels-theorem:p0073
...
% BLOG-PASSAGE: abels-theorem:p0074
...
% BLOG-PASSAGE: abels-theorem:p0075
\textit{Proof.}

% BLOG-PASSAGE: abels-theorem:p0076
    Set
    $$\Omega := C - \bigcup_{i = 1}^{2g} \gamma_i$$

% BLOG-PASSAGE: abels-theorem:p0077
Fix a point $b\in \Omega$, and define
$$A(p):= \int_{b}^{p}\omega$$

% BLOG-PASSAGE: abels-theorem:p0078
...
% BLOG-PASSAGE: abels-theorem:p0079
...
% BLOG-PASSAGE: abels-theorem:p0080
...
% BLOG-PASSAGE: abels-theorem:p0089
...
& (\mu_1,\ldots,\mu_g)\big(\Pi Q\Pi^T\big)
  (\nu_1,\ldots,\nu_g)^T=0
  \quad\text{for all $\mu,\nu$}\\
&\hspace{5em}\iff \Pi Q\Pi^T=0,
\end{aligned}
\]
\[
\begin{aligned}
& \sqrt{-1}(\mu_1,\ldots,\mu_g)
  \big(\Pi Q\overline{\Pi}^T\big)
  (\overline{\mu}_1,\ldots,\overline{\mu}_g)^T>0
  \quad\text{for all $\mu\ne0$}\\
&\hspace{5em}\iff
  \sqrt{-1}\Pi Q\overline{\Pi}^T
  \text{ is a positive definite Hermitian matrix}.
\end{aligned}
\]

% BLOG-PASSAGE: abels-theorem:p0090
Therefore, Riemann's Bilinear Relations are equivalent to the following matrix identities:
\begin{enumerate}[(a)]
    \item $A^TB = B^TA$
    \item $\sqrt{-1}(A^T\overline{B} - B^T\overline{A}) \text{ is a positive definite Hermitian matrix}$.
\end{enumerate}

% BLOG-PASSAGE: abels-theorem:p0091
...
% BLOG-PASSAGE: abels-theorem:p0094
$$\phi' = \phi - \sum_{j=1}^{g}\bigg(\int_{\gamma_j}\phi\bigg)\omega_j$$

% BLOG-PASSAGE: abels-theorem:p0095
...
% BLOG-PASSAGE: abels-theorem:p0096
...
% BLOG-PASSAGE: abels-theorem:p0101
which yields
$$\sum_{j=1}^{n}\int_{q_j}^{p_j}\omega_i = \pi_{g+i}(\phi')   (\dagger)$$

% BLOG-PASSAGE: abels-theorem:p0102
...
% BLOG-PASSAGE: abels-theorem:p0103
...
% BLOG-PASSAGE: abels-theorem:p0111
