...
Before setting up the construction of the Jacobian variety and proceeding further, let us acquaint ourselves with two important theorems. Throughout this exposition, $C$ will be a compact Riemann surface of genus $g$, $\Omega^1(C)$ the vector space of holomorphic $1$ forms on $C$ with basis $\omega_1, \ldots, \omega_g$, and $\mathcal{M}^1(C)$ the space of meromorphic differentials on $C$.
