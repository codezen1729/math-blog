...
Now let us illustrate another application of Tool $1$ by proving that, for $n\geq3$, the dihedral group \(D_n\) is isomorphic to \(\operatorname{Aut}(C_n),\) where $C_n$ is the cyclic graph on $n$ vertices.
