...
writePage('lab','lab','Laboratory · The Iteration Café','Explore complex dynamics and use Math Chatbox to search the papers of S. Viswanathan.',frame('<main id="main-content" class="lab-page"><div class="blog-laboratory-content"><header class="journal-heading"><h1>Laboratory</h1></header><p class="article-loading">Opening Math Chatbox and interactive experiments…</p></div></main>'),'../');
