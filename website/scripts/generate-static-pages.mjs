...
writePage('lab','lab','Laboratory · The Iteration Café','Explore complex dynamics and ask questions about correspondences on hyperelliptic surfaces.',frame('<main id="main-content" class="lab-page"><div class="blog-laboratory-content"><header class="journal-heading"><h1>Laboratory</h1></header><p class="article-loading">Opening the paper chat and interactive experiments…</p></div></main>'),'../');
