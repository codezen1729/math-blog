...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0003
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0004
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0005
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.52\linewidth]{note6-fig-01.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0006
Therefore, \(\gamma_0\sim\gamma_1\), with fixed endpoints, if and only if \(\gamma_0+(-\gamma_1)\) is homotopic to a point.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0007
\textit{Proof.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0008

The following figures illustrate these deformations.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0009
\[
  \gamma_0\sim\gamma_1
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0010
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.66\linewidth]{note6-fig-02.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0011
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0012
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0013
Also,
\[
  \gamma_0\sim\gamma_1
  \quad\Longleftrightarrow\quad
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0014
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.58\linewidth]{note6-fig-03.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0015
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\linewidth]{note6-fig-04.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0016
Here,
\[
  H'(t,s):=
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0017
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0018

wording of Tool 21.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0019
If \(U\) is a domain and \(\gamma_0,\gamma_1:[a,b]\to U\) are two continuous curves, then there exists a continuous map
\[
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0020
\textit{Proof.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0021
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0022
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0023
Suppose you are given a ``free'' homotopy \(H(t,s)\), a collection of curves \(\gamma_t(s):=H(t,s)\) for a given \(t\). Let
\[
...
\]
where \(P\) is a partition of \([0,1]\). The restriction \(\left.f\right|_{H([0,1]\times[0,1])}\) is also uniformly continuous, and so are \(\gamma_t(s)\) and \(\gamma_{t'}(s)\).

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0024
Given \(\varepsilon\),
\begin{align*}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0025
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0030
An important consequence, when the contour has only finitely many transverse self-intersections, is that it can be written as a finite concatenation of simple smooth curves: away from the intersection points it is locally like a rotated graph, as ``non-loopy'' as an interval. Corollary: every polygon is a sum of simple polygons.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0031
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0032
Let
\[
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0033
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0034
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0035
\[
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0036
\textbf{Exercise.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0037
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0038
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0039
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0040
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0041
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0042
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0043
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0044
\textit{Proof.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0045
\textbf{Remark.}
These singularity spikes ensure that there are no holes in the domain, for if there is one, they shall explode with a residue. So, if all holomorphic functions are conservative, in the sense that they have no residue, then ``there are no holes in \(U\).''

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0046
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0047
\textbf{Exercise.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0048
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0049

them until they meet some other point on the polygon \(\gamma_P\). This will split the polygon into two.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0050
\[
  \gamma_1+\gamma_2=\gamma.
\]

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0051
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\linewidth]{note6-fig-05.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0052
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0053
\textbf{Remark.}
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0054
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0055
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0056
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0057
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.90\linewidth]{note6-fig-06.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0058
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0059
...
We know \(\gamma\) is locally a rotated graph, so, after using the graph coordinate as parameter, the real mean-value theorem gives a point \(t'\in(a,b)\) such that
\[
  \arg\bigl(\gamma'(t')\bigr)
  =\arg\left(\frac{\gamma(b)-\gamma(a)}{b-a}\right).
\]
Essentially, these arguments are the same. So, locally, if we establish the fact that
\[
  \arg(\gamma'(t_0))
\]
is continuous in \(t_0\), then we are done. This is easy to see because, locally around the nonzero number \(\gamma'(t_0)/|\gamma'(t_0)|\), a branch of the logarithm is defined. Now, in that neighbourhood, \(\frac{\gamma'(t)}{|\gamma'(t)|}\)
is continuous, so
\[
  \log_0\left(\frac{\gamma'(t)}{|\gamma'(t)|}\right)
\]
is continuous. Therefore, \(\arg(\gamma'(t))\) is continuous near \(t_0\), which is precisely what we need.

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0060
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.62\linewidth]{note6-fig-07.pdf}

\end{figure}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0061
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0062
...
% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0063

\subsection*{Problems}
\emph{The motto of a problem is that it should make your life problematic.}

% BLOG-PASSAGE: homotopy-paths-and-jordan-curves:p0064
\begin{enumerate}
  ...
  \item Let \(f:D\to\mathbb C\) be holomorphic. If
  \[
