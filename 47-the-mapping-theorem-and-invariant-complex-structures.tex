...
\end{definition}
% Source page 6
The three definitions are equivalent. The implication $(1)\Rightarrow(2)$ is clear.
...
\end{figure}
Shrink $N_{g(z)}$ to be simply connected, let $R$ be its Riemann map, and choose an appropriate lift $\widetilde R$ as shown in the diagram.
\begin{figure}[H]\centering
