...
% BLOG-CONTENT-BEGIN
% BLOG-PASSAGE: third-surgery:p0001
\begin{center}
...
% BLOG-PASSAGE: third-surgery:p0002
...
% BLOG-PASSAGE: third-surgery:p0003
...
% BLOG-PASSAGE: third-surgery:p0004
...
% BLOG-PASSAGE: third-surgery:p0005
...
% BLOG-PASSAGE: third-surgery:p0006
...
% BLOG-PASSAGE: third-surgery:p0007
...
% BLOG-PASSAGE: third-surgery:p0008
...
% BLOG-PASSAGE: third-surgery:p0011
...
% BLOG-PASSAGE: third-surgery:p0012
...
% BLOG-PASSAGE: third-surgery:p0013
...
% BLOG-PASSAGE: third-surgery:p0014
...
% BLOG-PASSAGE: third-surgery:p0015
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-01.pdf}
    \FigureTag{MS1}{fig:ms-01}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0016
...
% BLOG-PASSAGE: third-surgery:p0017
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-02.pdf}
    \FigureTag{MS2}{fig:ms-02}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0018
...
% BLOG-PASSAGE: third-surgery:p0019
...
% BLOG-PASSAGE: third-surgery:p0020
...
% BLOG-PASSAGE: third-surgery:p0021
    (2) Observe that if $\phi$ is identity on the ideal boundary of $U$, then
    $\sup_{z\in U}d_U(\phi(z),z)<\infty$, where $d_U$ is the Poincar\'e distance on the hyperbolic surface $U\cong\mathbb D$; this is the standard bounded-displacement property of a quasiconformal self-map of the disk with identity boundary values \cite{mcmullen1988automorphisms}. Suppose this supremum is less than $K$. Given any $\{x_k\}_k$ such that $x_k\rightarrow x\in\partial U$, we have $\phi(x_k)\in B_K(x_k)$. Since $\overline U$ is compact in $\hat{\mathbb C}$ and $U$ is hyperbolic, the fixed-radius Poincar\'e balls $B_K(x_k)$ converge to $x$ in the spherical topology. In particular, $\phi(x_k)\rightarrow x$, so $\phi$ extends continuously to $\partial U$ and $\phi\big|_{\partial U}=\operatorname{Id}$. A direct application of Rickman's lemma now completes the proof.

% BLOG-PASSAGE: third-surgery:p0022
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-13.pdf}
    \FigureTag{MS13}{fig:ms-13}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0023
...
% BLOG-PASSAGE: third-surgery:p0024
...
% BLOG-PASSAGE: third-surgery:p0025
...
% BLOG-PASSAGE: third-surgery:p0026
...
% BLOG-PASSAGE: third-surgery:p0027
    ...
    \]
    (Note: In what's to follow $K$ shall be a forward invariant component of $J(f)$ unless otherwise stated).

% BLOG-PASSAGE: third-surgery:p0028


    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-03.pdf}
    \FigureTag{MS3}{fig:ms-03}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0029
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-04.pdf}
    \FigureTag{MS4}{fig:ms-04}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0030
...
% BLOG-PASSAGE: third-surgery:p0031

    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-05.pdf}
...
% BLOG-PASSAGE: third-surgery:p0032
...
% BLOG-PASSAGE: third-surgery:p0033
...
% BLOG-PASSAGE: third-surgery:p0034
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-06.pdf}
    \FigureTag{MS6}{fig:ms-06}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0035
...
% BLOG-PASSAGE: third-surgery:p0036
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-17.pdf}
    \FigureTag{MS17}{fig:ms-17}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0037
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-18.pdf}
    \FigureTag{MS18}{fig:ms-18}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0038


    We are now ready to state and prove the Gluing Lemma.

% BLOG-PASSAGE: third-surgery:p0039
...
% BLOG-PASSAGE: third-surgery:p0040
    Assume $f$ and $B$ are compatible on $I(U)$ via maps $\phi_U$ and $\phi_V$. Then the map

% BLOG-PASSAGE: third-surgery:p0041
    $$g(z):= \begin{cases}
        f(z), &\quad\text{if}  z \notin U\\
        \phi_V^{-1}\circ B\circ \phi_U(z) &\quad\text{if}   z\in U\\
        \end{cases}$$

% BLOG-PASSAGE: third-surgery:p0042
    is quasirational.

% BLOG-PASSAGE: third-surgery:p0043
    ...
    \end{cases}
    \]
    It also induces the identity map on the ideal boundary since $\hat{f} = \hat{\phi}_V^{-1}\circ B\circ\hat{\phi}_U = \hat{g}:I(U)\rightarrow I(V)$. Proposition $6.7$ gives the continuous identity extension across the physical boundary, and Proposition $6.5$ supplies the quasiconformal pasting. Composing with $f$ shows that $g$ is quasiregular away from the branch points; the isolated branch points are removable for quasiregular maps. Hence $g$ is quasiregular. Its dilatation is bounded by the maximum of $K(f)$ and $K(\phi_U)K(\phi_V)$.\\

% BLOG-PASSAGE: third-surgery:p0044
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-07.pdf}
    \FigureTag{MS7}{fig:ms-07}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0045
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-08.pdf}
    \FigureTag{MS8}{fig:ms-08}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0046
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-09.pdf}
    \FigureTag{MS9}{fig:ms-09}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0047
...
% BLOG-PASSAGE: third-surgery:p0048
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-10.pdf}
    \FigureTag{MS10}{fig:ms-10}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0049
    ...
    \]
    and compares the chains $\langle N_k\rangle_k$ and $\langle\psi(N_k)\rangle_k$.

% BLOG-PASSAGE: third-surgery:p0050
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-12.pdf}
    \FigureTag{MS12}{fig:ms-12}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0051
    The identity ideal-boundary values force these chains to be equivalent, as in the MS13 diagram above; making this into the required uniform hyperbolic-distance estimate needs the standard bounded-displacement theorem used in Proposition $6.7$.

% BLOG-PASSAGE: third-surgery:p0052
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-11.pdf}
...
% BLOG-PASSAGE: third-surgery:p0053
...
% BLOG-PASSAGE: third-surgery:p0054
        is quasirational.

% BLOG-PASSAGE: third-surgery:p0055
...
% BLOG-PASSAGE: third-surgery:p0056
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-19.pdf}
    \FigureTag{MS19}{fig:ms-19}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0057
    \begin{figure}[H]\centering
    \includegraphics[width=.95\linewidth]{ms-fig-14.pdf}
    \FigureTag{MS14}{fig:ms-14}
    \end{figure}

% BLOG-PASSAGE: third-surgery:p0058
\begin{center}
